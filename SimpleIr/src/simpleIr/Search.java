...
public class Search {
	public static void main(String[] args) {
	      ...
	      try {
	         File inputFile = new File("C:\\Users\\Aqil Ikhwan\\OneDrive\\Documents\\SimpleIr\\collection.xml");
	         ...
	         for (int temp = 0; temp < nList.getLength(); temp++) {
		        ...
		        TransformerFactory transformerFactory = TransformerFactory.newInstance();
		 		...
		 		StreamResult result = new StreamResult(new FileOutputStream(new File("C:\\\\Users\\\\Aqil Ikhwan\\\\OneDrive\\\\Documents\\\\SimpleIr\\\\index.xml")));
